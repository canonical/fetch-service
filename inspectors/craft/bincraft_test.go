		...
		"git.upload-pack": &Inspection{
			...
			Annotations: Annotation{
				"client-request": []string{
					...
					"ofs-delta",
					"deepen 1",
					"want 9f2b5058f63af377b85493925fdd68c37dab1dbb",
					"done",
				},
				...
				"protocol":   "version=2",
				"wants": []string{
					"9f2b5058f63af377b85493925fdd68c37dab1dbb",
				},
				"is-shallow": true,
			},
		},
...
func loadTestBincraftArtifactData() (*files.ArtifactFile, error) {
	bincraftFile := filepath.Join("testdata", "bincraftpkg.raw")
	file, err := files.OpenArtifactFile(bincraftFile)
	return file, err
}
...
func (s *bincraftSuite) TestBincraftGitInspectArtifact(c *C) {
	for _, tc := range []struct {
		...
		c.Assert(err, IsNil)
		err = git.Checkout(checkoutPath, "9f2b5058f63af377b85493925fdd68c37dab1dbb", s.sl)
		c.Assert(err, IsNil)
		...
		if tc.opinion == opinions.Approved {
			...
			c.Check(a.Metadata.ContentID, Equals, "9f2b5058f63af377b85493925fdd68c37dab1dbb")
		}
	}
}
